...
| 14 Marketplace | Digital Resources Marketplace (`/store`): free/paid downloads, secure delivery, passwordless buyer accounts, Razorpay + UPI, moderated reviews, admin suite + analytics (`docs/MARKETPLACE.md`). **Phase 2 done:** admin **AI authoring tools** (excerpt/SEO/tags/MCQs/flashcards, incl. PDF grounding), analytics bar charts, bookmarks UX. **Phase 3 designed:** thesis library, exam-prep bundles, memberships. | ◐ |

...
export async function POST(req: NextRequest) {
  ...
  const { clientId, resumeText } = parsed.data;
  ...
  try {
    return NextResponse.json(await analyzeResume({ clientId, ip }, resumeText));
  } catch {

...
---
_Last updated: 2026-06-16 — AI (multimodal chat, Career Copilot) + **Donations** (`/donate`, `/donate/receipt/[id]`, `/api/donations/*`, `/admin/donations`) + admin AI/donation settings + the UX pass._

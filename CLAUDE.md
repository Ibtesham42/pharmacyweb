...
---
_Last updated: 2026-06-16 — AI module (Groq chat + multimodal + Career Copilot, see `docs/AI.md`) and the **Donation/Support platform** (Razorpay + UPI/QR, see `docs/DONATIONS.md`), on top of the UX pass and Phase 11 MVP. Commerce store deferred._
